  ...
  const cards = [
    {
      ...
      detailedDescription:
        "Our AI considers soil pH, nutrient levels, rainfall patterns, temperature ranges, elevation, and historical yield data to recommend crops that will thrive in your conditions.",
      tag: "AI Powered",
      category: "ai",
    ...
    },
    {
      ...
      detailedDescription:
        "Predict your harvest volume weeks or months in advance based on crop type, soil health metrics, weather forecasts, and your farming practices.",
      tag: "ML Analytics",
      category: "ai",
    ...
    },
    {
      ...
      detailedDescription:
        "Upload images of your crops or use our mobile scanning feature to identify issues before they spread.",
      tag: "Early Detection",
      category: "health",
    ...
    },
    {
      ...
      detailedDescription:
        "Access comprehensive guides on soil preparation, natural pest management, organic certification processes, and sustainable farming techniques.",
      tag: "Sustainable",
      category: "resources",
    ...
    },
    {
      ...
      detailedDescription:
        "Get precise, field-level weather forecasts including rainfall probability, temperature fluctuations, and wind patterns.",
      tag: "Real-Time",
      category: "analytics",
    ...
    },
    {
      ...
      detailedDescription:
        "Understand your soil's nutrient profile, organic matter content, and texture characteristics.",
      tag: "Soil Science",
      category: "analytics",
    ...
    },
    {
      ...
      detailedDescription:
        "Maximize water efficiency while ensuring your crops receive optimal moisture levels.",
      tag: "Water Efficiency",
      category: "ai",
      stats: "Reduce water usage by up to 30%",
      onClick: () => {
        navigate("/smartfarming");
      },
    },
    {
      image: "/market.webp",
      ...
      detailedDescription:
        "Access current and historical price data for your crops across different markets and regions.",
      ...
      <div className="max-w-7xl mx-auto relative bg-[#f5f5dc] px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="text-center max-w-4xl mx-auto mb-12 md:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 tracking-tight mb-4 md:mb-6 font-playfair">
            Intelligent{" "}
            <span className="text-green-700">Farming Solutions</span>
          </h2>
          <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed mb-8 md:mb-10 max-w-3xl mx-auto font-light px-2">
            Discover our comprehensive suite of tools designed to empower
            farmers with{" "}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-5 mb-12 md:mb-16 max-w-5xl mx-auto px-2">
          {[
            ...
            <div
              key={index}
              className="bg-white/30 backdrop-blur-sm p-3 sm:p-4 md:p-5 rounded-lg md:rounded-xl shadow-sm border border-green-100/50 text-center transition-transform hover:scale-105"
            >
              <div
        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-12 md:mb-16 px-2">
          {filteredCards.map((card, index) => (
            ...
            >
              <Card {...card} isHovered={hoveredCard === index} />
            </div>
          ))}
        </div>
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <img
                  ...
                  className={`relative rounded-2xl shadow-2xl w-full h-auto transform transition-all duration-700 ${
                    isVisible
            ...
            <div className="flex-1">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-green-900 mb-4 leading-tight">
                  Your 24/7{" "}
                  <span className="text-emerald-600">Farming Assistant</span>
                </h2>
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Our AI-powered chatbot is specifically designed to help
                  farmers with agricultural queries, crop management advice,
                  weather information, and troubleshooting common farming
                  challenges.
                </p>
                ...
                <div className="space-y-5 mb-8">
                  <div className="flex items-start gap-4 p-3 bg-green-50 rounded-xl hover:bg-green-100 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Get answers to your farming questions anytime, day or
                        night
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 bg-green-50 rounded-xl hover:bg-green-100 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Region-specific guidance based on your location and soil
                        conditions
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 bg-green-50 rounded-xl hover:bg-green-100 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Access information from agricultural experts and
                        research databases
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-center text-center sm:text-left">
                  ...
                  <div className="bg-gradient-to-br from-green-400 to-emerald-600 p-3 md:p-4 rounded-full shadow-inner">
                    ...
                    >
                      <path
                        ...
                        strokeWidth="2"
                        d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.586m-7.614 2.828a4 4 0 010-5.656M15 10h-1.586m-7.614 2.828a4 4 0 005.656 0M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
                      ></path>
                    </svg>
                  </div>
              ...
              <div className="flex-1">
                ...
                <blockquote className="text-gray-700 italic text-center sm:text-left leading-relaxed">
                  <span className="text-2xl md:text-3xl text-green-500 font-serif leading-none">
                    "
                  </span>
                  Using these tools increased my profits by 35% in the first
                  season alone. The yield prediction helped me plan my storage
                  and the crop advisor suggested the perfect rotation.
                  <span className="text-2xl md:text-3xl text-green-500 font-serif leading-none">
                    "
                  </span>
                </blockquote>
      ...
      <div className="bg-green-900 pt-16 pb-16 md:pt-20 rounded-tl-[40px] md:rounded-tl-[80px] rounded-tr-[40px] md:rounded-tr-[80px]">
        <div className="text-center bg-gradient-to-r from-green-600/90 to-emerald-700/90 rounded-xl md:rounded-4xl p-6 sm:p-8 md:p-10 lg:p-12 text-white max-w-xs sm:max-w-sm md:max-w-md lg:max-w-4xl mx-auto shadow-xl border border-green-500/30 backdrop-blur-sm relative overflow-hidden">
          ...
          <p className="mb-6 sm:mb-7 md:mb-8 text-green-100 max-w-xs sm:max-w-sm md:max-w-xl mx-auto text-base sm:text-lg relative z-10">
            Join thousands of farmers who are already increasing their yields
            and profits with our AI-powered platform.
          </p>
