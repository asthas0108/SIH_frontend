    ...
    const features = [
        {
            ...
            description: "Real-time monitoring of soil conditions, temperature, and humidity for optimal crop growth.",
            color: "from-amber-500 to-amber-600"
        },
        {
            icon: <FaSeedling className="text-3xl" />,
            title: "Crop Recommendation",
            description: "AI-powered suggestions for the best crops based on your soil type and regional climate.",
            color: "from-emerald-500 to-emerald-600"
        },
        {
            icon: <FaLeaf className="text-3xl" />,
            title: "Soil Analysis",
            description: "Detailed analysis of soil health and nutrient levels with personalized improvement plans.",
            color: "from-amber-700 to-amber-800"
        },
        {
            icon: <FaChartLine className="text-3xl" />,
            title: "Crop Analysis & Yield Prediction",
            description: "Advanced analytics to monitor crop health and predict yields with high accuracy.",
            color: "from-teal-500 to-teal-600"
        },
        {
            icon: <FaCloudSunRain className="text-3xl" />,
            title: "Precision Weather Analysis",
            description: "Hyper-local weather forecasts and alerts to help you make informed farming decisions.",
            color: "from-blue-500 to-blue-600"
        },
        {
            icon: <FaShoppingCart className="text-3xl" />,
            title: "Market Price Tracker",
            description: "Real-time market prices and trends to help you get the best value for your produce.",
            color: "from-green-500 to-green-600"
        },
        {
            icon: <FaLeaf className="text-3xl" />,
            title: "Organic Farming Guide",
            description: "Comprehensive resources and step-by-step guidance for transitioning to organic farming.",
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center mb-4 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                            ...
                            <span className="text-emerald-100 font-medium">Empowering Indian Farmers</span>
                        </div>
            ...
            <section className="py-16 md:py-20 px-4 relative">
                ...
                <div className="container mx-auto max-w-5xl relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-emerald-800 mb-4">Transforming Agriculture in India</h2>
                        <p className="text-lg text-emerald-700/90 max-w-3xl mx-auto leading-relaxed">
                            KisanMitra is dedicated to revolutionizing Indian agriculture by providing farmers with
                            cutting-edge technology and data-driven insights to maximize productivity, reduce costs,
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-emerald-100 hover:shadow-xl transition-all">
                            <div className="flex items-center mb-6">
                                ...
                                <h3 className="text-2xl font-semibold text-emerald-800">Our Aim</h3>
                            </div>
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-emerald-700">Increase farmer revenue by 30% within 3 years</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Reduce farming input costs by 20% through precision agriculture</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Promote sustainable farming practices across India</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Bridge the technology gap in Indian agriculture</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-emerald-100 hover:shadow-xl transition-all">
                            <div className="flex items-center mb-6">
                                ...
                                <h3 className="text-2xl font-semibold text-emerald-800">Our Goals</h3>
                            </div>
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                    ...
                                    <span className="text-emerald-700">Reach 1 million farmers by 2027</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Develop regional-specific solutions for diverse Indian agriculture</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Create India's largest agricultural database</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-emerald-600"></div>
                                    </div>
                                    <span className="text-emerald-700">Implement AI-driven solutions in 10,000 villages</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section className="py-16 md:py-20 px-4 bg-gradient-to-b from-emerald-50/50 to-white">
                <div className="container mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-emerald-800 mb-4">How We Increase Farmer Revenue</h2>
                        <p className="text-lg text-emerald-700/90">
                            Our comprehensive suite of tools and services helps farmers maximize their yield and profits
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className={`w-16 h-16 rounded-2xl mb-5 flex items-center justify-center bg-gradient-to-r ${feature.color} text-white`}>
                                    {feature.icon}
                                </div>
                ...
                <div className="container mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-base md:text-lg text-emerald-700/90 leading-relaxed">
                            A passionate and diverse group of innovators committed to transforming Indian agriculture.
                        </p>
                    </div>
                ...
                <div className="container mx-auto text-center relative z-10">
                    <div className="max-w-3xl mx-auto">
                        <div className="inline-flex items-center justify-center mb-4 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                            ...
                            <span className="text-emerald-100 font-medium">Get Started Today</span>
                        </div>
